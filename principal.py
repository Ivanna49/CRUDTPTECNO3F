...
def main():
    ...
    ventana.configure(background='#282c34')  # Cambia el color de fondo de la ventana

 
    estilo = ttk.Style()
    estilo.theme_use('clam')  # Usa el tema 'clam' para mejor compatibilidad con estilos personalizados
    estilo.configure('TButton', background='#d294e3', foreground='#faf2fc', font=('Arial', 12, 'bold'))
